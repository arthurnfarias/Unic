...
class AgendamentosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create agendamento" do
    assert_difference('Agendamento.count') do
      post agendamentos_url, params: { agendamento: { anotacao: @agendamento.anotacao, atendente: @agendamento.atendente, hora: @agendamento.hora, nome: @agendamento.nome, preco: @agendamento.preco } }
    end
  ...
  test "should update agendamento" do
    patch agendamento_url(@agendamento), params: { agendamento: { anotacao: @agendamento.anotacao, atendente: @agendamento.atendente, hora: @agendamento.hora, nome: @agendamento.nome, preco: @agendamento.preco } }
